...
export default function ShopPage() {
  ...
  const [selectedItem, setSelectedItem] = useState<ShopMedicineItem | null>(null);
        ...
        <div className="max-w-[1400px] mx-auto px-5 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-semibold text-gray-900">MediSure Shop</h1>
            </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {pageItems.map((item) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900">{item.medicineName}</h3>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {addingInventoryId === item.inventoryId ? "Adding..." : "Add"}
                    </button>
                  </div>
                </div>
              </article>
        ...
        <div className="fixed inset-0 bg-black/45 z-40 flex items-center justify-center p-4">
          <div className="w-full max-w-xl rounded-2xl border border-gray-200 bg-white shadow-xl p-5 z-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <Info label="Last Tx Hash" value={selectedItem.latestTxHash || "-"} mono />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/45 z-40 flex items-center justify-center p-4">
          <div className="w-full max-w-lg rounded-2xl border border-gray-200 bg-white shadow-xl p-5 z-50">
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between">
              <p className="text-sm text-gray-600">Items: {cart?.total_items || 0}</p>
              <button
                type="button"
                onClick={() => {
                  setCartOpen(false);
